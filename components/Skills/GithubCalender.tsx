  ...
  return (
    <>
      <div className="relative flex w-full flex-col">
        <ul className="flex justify-end gap-[3px] overflow-hidden text-xs dark:text-neutral-400 md:justify-start xl:mb-2 xl:justify-center xl:gap-[25px] xl:text-base">
          {months.map((month) => (
            <li
              key={month.firstDay}
              ...
              {week.contributionDays.map((contribution) => {
                ...
                return (
                  <motion.span
                    ...
                    className="my-[2px] block h-[10px] w-[10px] rounded-sm bg-neutral-800 lg:h-[12px] lg:w-[12px] xl:my-[5px] xl:h-[19px] xl:w-[19px] 2xl:h-[22px] 2xl:w-[22px]"
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-sm">
          ...
          <ul className="flex gap-1">
            <motion.li className="h-[10px] w-[10px] rounded-sm bg-neutral-800 lg:h-[12px] lg:w-[12px] xl:h-[19px] xl:w-[19px] 2xl:h-[22px] 2xl:w-[22px]" />
            {contributionColors.map((item, index) => (
              <motion.li
                ...
                className="h-[10px] w-[10px] rounded-sm lg:h-[12px] lg:w-[12px] xl:h-[19px] xl:w-[19px] 2xl:h-[22px] 2xl:w-[22px]"
